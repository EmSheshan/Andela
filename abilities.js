export const abilities = {
    ...
    // Lacadia
    "Parasitoid": {
        description: "This Pokémon's HP-draining moves have their HP recovery boosted by 30%.",
        tag: "lacadia"
    },
    "Ancient Guard": {
        description: "Rock-type moves are not very effective against this Pokémon and it is also immune to Stealth Rock.",
        tag: "lacadia"
    },
    "Ancient Force": {
        description: "Raises this Pokémon's attack stat by one stage for each hazard it's affected by.",
        tag: "lacadia"
    },
    "Pollyanna": {
        description: "Raises this Pokémon's HP when hit by a Dark-type move, instead of taking damage.",
        tag: "lacadia"
    },
    ...
    "Polarity": {
        description: "This Pokémon's Fire-type moves become slightly more powerful in snow, and its Ice-type moves become slightly more powerful in harsh sunlight.",
        tag: "lacadia"
    },
    "Noble Bearing": {
        description: "Boosts defense, special defense, and speed when this Pokémon successfully inflicts a status condition.",
        tag: "lacadia"
    },
    "Caffeine Rush": {
        description: "When the user's HP drops to 50% or lower, it restores a quarter of its health and maxes its Speed stat.",
        tag: "lacadia"
    },
    "Ruthless": {
        description: "This Pokémon's attacks always result in critical hits when the opponent has lowered stats.",
        tag: "lacadia"
    },
    "Malodorous": {
        description: "When this Pokémon is knocked out in battle, the opposing Pokémon has its stats lowered by one stage.",
        tag: "lacadia"
    },
    "Schrödinger": {description: "This Pokémon's normal type moves become ghost type, and vice versa.", tag: "lacadia"},
    "Surveil": {
        description: "When it enters a battle, the Pokémon can tell the speed stat of the opposing Pokémon.",
        tag: "lacadia"
    },
    "Backstabber": {
        description: "This Pokémon's attack moves will always hit a target first if that target is switching out of battle.",
        tag: "lacadia"
    },
    "Meltdown": {
        description: "This Pokémon will use the move Eruption immediately after being hit by a Fire-type move.",
        tag: "lacadia"
    },
    "Metal Eater": {
        description: "This Pokémon's moves become 30% more powerful when a Steel-type Pokémon is on the field.",
        tag: "lacadia"
    },
    "Momentum": {
        description: "This Pokémon's attack moves become more powerful each time they are used consecutively.",
        tag: "lacadia"
    },
    "Hunter's Instincts": {
        description: "When this Pokémon or an opposing Pokémon enters the battle, the Pokémon reveals whether the opponent can be knocked out in one hit.",
        tag: "lacadia"
    },
    "Brain Jack": {
        description: "This Pokémon's Psychic-type moves have a 50% chance of inflicting confusion, infatuation, disable, encore, or torment.",
        tag: "lacadia"
    },
    "Flightless": {description: "Powers up Flying-type moves.", tag: "lacadia"},
    "Life Aurora": {
        description: "Whenever an opposing Pokémon restores health, this Pokémon restores the same amount of health.",
        tag: "lacadia"
    },
    "Inrush Current": {
        description: "If the user's previous move has failed, the power of its next move doubles.",
        tag: "lacadia"
    },
    "Vitrified": {
        description: "Boosts its and its ally's special defense stat the first time the Pokémon enters a battle.",
        tag: "lacadia"
    },
    "Decay": {
        description: "All non-Ghost and Dark type Pokémon lose 1/16 of their max HP at the end of each turn.",
        tag: "lacadia"
    },
    "Circle of Protection": {
        description: "The Pokémon takes half damage from moves with a base power of 100 or higher.",
        tag: "lacadia"
    },
    "Stealth Strike": {
        description: "Semi-invulnerable moves deal 50% more damage, and deal 100% more damage if the target switches.",
        tag: "lacadia"
    },
    "Weight of the World": {
        description: "The Pokémon starts the effects of Gravity when it enters battle.",
        tag: "lacadia"
    },
    "Cry of the Cosmos": {
        description: "The Pokémon's presence allows Dark type Pokémon to be hit with Psychic type moves and doubles the chance all moves have an additional effect.",
        tag: "lacadia"
    },
    "Hoarder": {description: "The Pokémon gives a copy of its held item to it and its allies.", tag: "lacadia"},
    "Bell of Ruin": {
        description: "The Pokémon's bell rings when its HP becomes half or less. Then the Pokémon changes its form to Dirge Form.",
        tag: "lacadia"
    },
    "Dominion": {
    ...
    "Manifestation": {
        description: "Boosts the Pokémon's most proficient stat the first time the Pokémon enters a battle.",
        tag: "lacadia"
    },

    // Andela Abilities
    "Cloudburst": {
        description: "In rain, this Pokémon can immediately use moves that normally require a turn to charge.",
        tag: "andela"
    },
    "Pacifism": {
        description: "Whenever this Pokemon targets the opponent with a status move, the opponent's Sp. Atk stat is lowered by one stage.",
        tag: "andela"
    },
    "Ill Omen": {
